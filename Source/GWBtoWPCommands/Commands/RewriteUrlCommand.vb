...
Public Class RewriteUrlCommand
    ...
    Public Overrides ReadOnly Property Description As String
        Get
            Return "Replaces one URL with another"
        End Get
    End Property
    ...
    Protected Overrides Function RunCommand() As Integer
        ...
        For Each b In blogs
            ...
            For Each p In posts
                Try
                    ' TODO: Could be added to a Command line!
                    p = GWBProcedures.UrlReplacement(p, "http://geekswithblogs.net/hinshelm", "http://blog.hinshelwood.com")
